...
public class IsCoverAvaliableNode : Node
{
  ...
  public IsCoverAvaliableNode(List<Cover> avaliableCovers, Transform target, EnemyAI ai)
  {
  ...
  {
    //Uncomment this if you want to improve performance 
    ...
    for (int i = 0; i < avaliableCovers.Count; i++)
    {
